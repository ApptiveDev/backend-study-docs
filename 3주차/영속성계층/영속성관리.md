...
![cache_read](<1차_캐시_hit.png>)

#### 찾는 엔티티가 1차 캐시에 없는 경우
 
![cache_read](<1차_캐시_miss.png>)
...
![lazy_write](<쓰기_지연_저장소_그림.png>)


![lazy_write](<쓰기_지연.png>)
